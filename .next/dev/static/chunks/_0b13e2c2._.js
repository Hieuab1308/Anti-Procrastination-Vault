...
"[project]/hooks/useAntiProcrastination.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const useAntiProcrastination = ()=>{
    ...
    const [commitmentId, setCommitmentId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useAntiProcrastination.useEffect": ()=>{
    ...
    const { data: objectData, isPending: isFetching, error: queryError, refetch } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$iota$2f$dapp$2d$kit$2f$dist$2f$esm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useIotaClientQuery"])("getObject", {
        id: commitmentId,
        options: {
            showContent: true,
            showOwner: true
    ...
    // CREATE COMMITMENT
    // ============================================================================
    const createCommitment = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useAntiProcrastination.useCallback[createCommitment]": async (params)=>{
            ...
            try {
                ...
                signAndExecute({
                    ...
                    onSuccess: {
                        "useAntiProcrastination.useCallback[createCommitment]": async ({ digest })=>{
                            setHash(digest);
                            try {
                                ...
                                const createdObject = effects?.created?.find({
                                    "useAntiProcrastination.useCallback[createCommitment]": (obj)=>obj.owner && typeof obj.owner === "object" && "Shared" in obj.owner
                                }["useAntiProcrastination.useCallback[createCommitment]"]);
                    ...
                    onError: {
                        "useAntiProcrastination.useCallback[createCommitment]": (err)=>{
    ...
    // ============================================================================
    const confirmCompleted = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useAntiProcrastination.useCallback[confirmCompleted]": async (targetCommitmentId)=>{
            if (!packageId) return;
            try {
                setIsLoading(true);
                setTransactionError(null);
                ...
                signAndExecute({
                    ...
                    onSuccess: {
                        "useAntiProcrastination.useCallback[confirmCompleted]": async ({ digest })=>{
                            setHash(digest);
                    ...
                    }["useAntiProcrastination.useCallback[confirmCompleted]"],
                    onError: {
                        "useAntiProcrastination.useCallback[confirmCompleted]": (err)=>{
                            const error = err instanceof Error ? err : new Error(String(err));
                            setTransactionError(error);
    ...
    // ============================================================================
    const confirmFailed = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useAntiProcrastination.useCallback[confirmFailed]": async (targetCommitmentId)=>{
            if (!packageId) return;
            try {
                setIsLoading(true);
                setTransactionError(null);
                ...
                signAndExecute({
                    ...
                    onSuccess: {
                        "useAntiProcrastination.useCallback[confirmFailed]": async ({ digest })=>{
                            setHash(digest);
                            await iotaClient.waitForTransaction({
                                digest
                            });
                    ...
                    }["useAntiProcrastination.useCallback[confirmFailed]"],
                    onError: {
                        "useAntiProcrastination.useCallback[confirmFailed]": (err)=>{
                            const error = err instanceof Error ? err : new Error(String(err));
                            setTransactionError(error);
    ...
    // ============================================================================
    const claimExpired = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useAntiProcrastination.useCallback[claimExpired]": async (targetCommitmentId)=>{
            if (!packageId) return;
            try {
                setIsLoading(true);
                setTransactionError(null);
                ...
                signAndExecute({
                    ...
                    onSuccess: {
                        "useAntiProcrastination.useCallback[claimExpired]": async ({ digest })=>{
                            setHash(digest);
                            await iotaClient.waitForTransaction({
                                digest
                            });
                    ...
                    }["useAntiProcrastination.useCallback[claimExpired]"],
                    onError: {
                        "useAntiProcrastination.useCallback[claimExpired]": (err)=>{
                            const error = err instanceof Error ? err : new Error(String(err));
                            setTransactionError(error);
    ...
    // UTILITY FUNCTIONS
    // ============================================================================
    const loadCommitment = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useAntiProcrastination.useCallback[loadCommitment]": (newCommitmentId)=>{
            setCommitmentId(newCommitmentId);
            setTransactionError(null);
            if ("TURBOPACK compile-time truthy", 1) {
                window.location.hash = newCommitmentId;
    ...
    }["useAntiProcrastination.useCallback[loadCommitment]"], []);
    const clearCommitment = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useAntiProcrastination.useCallback[clearCommitment]": ()=>{
...
_s(useAntiProcrastination, "G+bunDLeWnceGZeRphgff88rtCM=", false, function() {
    return [
...
"[project]/components/CreateCommitmentForm.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useAntiProcrastination$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/hooks/useAntiProcrastination.ts [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
const CreateCommitmentForm = ({ onSubmit, isPending, error })=>{
    ...
    const [stakeIota, setStakeIota] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("0.1");
    const [arbiter, setArbiter] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    const [penaltyRecipient, setPenaltyRecipient] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
    ...
    const handleSubmit = async (e)=>{
        ...
        await onSubmit({
            stakeAmount: (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useAntiProcrastination$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["iotaToMist"])(parseFloat(stakeIota)),
...
"[project]/components/CommitmentCard.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const CommitmentCard = ({ commitment, isOwner, isArbiter })=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CommitmentCard.useEffect": ()=>{
            const updateTimer = {
                "CommitmentCard.useEffect.updateTimer": ()=>{
                    setTimeRemaining((0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useAntiProcrastination$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatTimeRemaining"])(commitment.deadline));
                    setIsExpired((0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useAntiProcrastination$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["isCommitmentExpired"])(commitment.deadline));
                }
            }["CommitmentCard.useEffect.updateTimer"];
            updateTimer();
            ...
            ;
            return ({
                "CommitmentCard.useEffect": ()=>clearInterval(interval)
            })["CommitmentCard.useEffect"];
        }
    }["CommitmentCard.useEffect"], [
        commitment.deadline
    ...
    const getStatusBadge = ()=>{
        switch(commitment.status){
            case __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useAntiProcrastination$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["COMMITMENT_STATUS"].PENDING:
...
_s(CommitmentCard, "srkew7DmtBkofrFQbUpDPi2KSx0=");
_c = CommitmentCard;
var _c;
...
"[project]/components/LoadCommitmentForm.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const LoadCommitmentForm = ({ onLoad })=>{
    _s();
    const [commitmentId, setCommitmentId] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("");
...
_s(LoadCommitmentForm, "TCNaS+HVB9Ja56cZf4Iu6NJEd80=");
_c = LoadCommitmentForm;
var _c;
__turbopack_context__.k.register(_c, "LoadCommitmentForm");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/components/AntiProcrastinationVault.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$radix$2d$ui$2f$themes$2f$dist$2f$esm$2f$components$2f$separator$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@radix-ui/themes/dist/esm/components/separator.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$spinners$2f$ClipLoader$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/react-spinners/ClipLoader.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$CreateCommitmentForm$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/CreateCommitmentForm.tsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$CommitmentCard$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/CommitmentCard.tsx [app-client] (ecmascript)");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$components$2f$LoadCommitmentForm$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/components/LoadCommitmentForm.tsx [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
"use client";
;
...
const AntiProcrastinationVault = ()=>{
    _s();
    const currentAccount = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$iota$2f$dapp$2d$kit$2f$dist$2f$esm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCurrentAccount"])();
    const { data, actions, state, commitmentId, isOwner, isArbiter, address } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useAntiProcrastination$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAntiProcrastination"])();
                ...
                !commitmentId ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$radix$2d$ui$2f$themes$2f$dist$2f$esm$2f$components$2f$flex$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Flex"], {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$radix$2d$ui$2f$themes$2f$dist$2f$esm$2f$components$2f$card$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$CreateCommitmentForm$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CreateCommitmentForm"], {
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$radix$2d$ui$2f$themes$2f$dist$2f$esm$2f$components$2f$card$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                            ...
                            children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$LoadCommitmentForm$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["LoadCommitmentForm"], {
                    ...
                    children: [
                        ...
                        data && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$CommitmentCard$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CommitmentCard"], {
                                    commitment: data,
                                    isOwner: isOwner,
                                    isArbiter: isArbiter,
...
_s(AntiProcrastinationVault, "162tS2gYvrTQAfZOp3706oWoPWo=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$iota$2f$dapp$2d$kit$2f$dist$2f$esm$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCurrentAccount"],
        __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$useAntiProcrastination$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAntiProcrastination"]
    ];
});
_c = AntiProcrastinationVault;
const __TURBOPACK__default__export__ = AntiProcrastinationVault;
var _c;
__turbopack_context__.k.register(_c, "AntiProcrastinationVault");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_0b13e2c2._.js.map